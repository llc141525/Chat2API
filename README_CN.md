...
| Provider | 默认模型 | 文档 |
| --- | --- | --- |
| DeepSeek | deepseek-v4-flash, deepseek-v4-pro | [使用说明](docs/providers/deepseek.md) |
| GLM | GLM-5.2, GLM-5.1 | [使用说明](docs/providers/glm.md) |
| Kimi | Kimi-K3, Kimi-K2.6 | [使用说明](docs/providers/kimi.md) |
| MiniMax | MiniMax-M2.7 | [使用说明](docs/providers/minimax.md) |
| Mimo | MiMo-V2.5-Pro-UltraSpeed, MiMo-V2.5-Pro, MiMo-V2.5, MiMo-V2-Flash | [使用说明](docs/providers/mimo.md) |
| Perplexity | Auto | [使用说明](docs/providers/perplexity.md) |
| Qwen | Qwen3.6, Qwen3.7-Max, Qwen3.5-Flash, Qwen3-Max, Qwen3-Max-Thinking-Preview, Qwen3-Coder | [使用说明](docs/providers/qwen.md) |
| Qwen AI | Qwen3.7-Max, Qwen3.6-Plus, Qwen3.6-35B-A3B, Qwen3.6-27B, Qwen3-Coder | [使用说明](docs/providers/qwen-ai.md) |
| Z.ai | 受前端验证码风控限制，暂不可用 | [使用说明](docs/providers/zai.md) |
